  ...
  const timeline = [
    {
      ...
      description: "B.Tech CSE (4th Year) | Specializing in Generative AI, LLMs, RAG Systems & ML Engineering",
      icon: GraduationCap,
    },
    {
      type: "internship",
      ...
      description: "Led user research and frontend design system development, collaborating cross-functionally with development teams to improve product usability metrics.",
      icon: Briefcase,
    },
    {
      type: "education",
    ...
    },
    {
      ...
      period: "2020",
      description: "Academic excellence with focus on STEM subjects",
      icon: GraduationCap,
    },
  ];
